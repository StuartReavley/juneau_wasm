            ...
            (left_val, right_val) => {
                if !(*left_val == *right_val) {
                    panic!("assertion failed: `(left == right)`\
                          ...
                          \n{}\
                          \n",
                           $crate::dump::pretty_assertions::Comparison::new(left_val, right_val))
                }
            }
        }
    });
                ...
                if *left_val == *right_val {
                  ...
                  if left_dbg != right_dbg {
                      ...
                      panic!("assertion failed: `(left != right)`{}{}\
                            ...
                            \n",
                             ...
                             format_args!($($arg)+),
                             crate::dump::pretty_assertions::Comparison::new(left_val, right_val),
                             crate::dump::pretty_assertions::Style::new()
                                 .bold()
                                 .underline()
                                 .paint("Note"))
                  }
                  ...
                  panic!("assertion failed: `(left != right)`{}{}\
                        ...
                        \n",
                         $maybe_semicolon,
                         format_args!($($arg)+),
                         crate::dump::pretty_assertions::Style::new().bold().paint("Both sides"),
                         left_val)
                }
            }
        }
...
"#)]
        fn fails() {
            crate::assert_eq_pretty!(666, 999);
        }
...
"#
        ...
        fn fails_custom() {
            crate::assert_eq_pretty!(666, 999, "custom panic message");
        }
...
"#
        ...
        fn fails_custom() {
            assert_ne!(666, 666, "custom panic message");
        }
